...
ActiveRecord::Schema.define(version: 20150714174932) do
  ...
  create_table "courses_major_requirements", force: :cascade do |t|
    t.integer "course_id",            limit: 4
    t.integer "major_requirement_id", limit: 4
  end
  ...
  create_table "major_requirements", force: :cascade do |t|
    t.integer  "major_id",         limit: 4
    t.integer  "credits_required", limit: 4
